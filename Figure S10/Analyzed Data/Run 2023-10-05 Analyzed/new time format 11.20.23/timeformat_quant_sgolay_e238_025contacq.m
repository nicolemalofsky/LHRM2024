...
data = readmatrix('timeformat _ formatted raw tab only 228 pt dont use button just paste into tab 1 --- MACRO 2023-10-05 Expt 238 pcr and post melt cont 025 ramp');
%data = readmatrix('new E238 time conversion of formatted raw tab - time tab only');
%%% ******* code not working so use E237 for E238 analysis! 
