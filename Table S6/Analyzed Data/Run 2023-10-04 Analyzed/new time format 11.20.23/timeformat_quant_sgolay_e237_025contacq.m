...
%%%data = readmatrix('time format _ formatted raw tab only 228 pt dont use button just paste into tab 1 --- MACRO 2023-10-04 Expt 237 pcr and post melt cont 025 ramp');
%data = readmatrix('new E237 time conversion of formatted raw tab - time tab only');
data = readmatrix('new E238 time conversion of formatted raw tab - time tab only');
...
%%%% this melt has 228 points in E235!!!
