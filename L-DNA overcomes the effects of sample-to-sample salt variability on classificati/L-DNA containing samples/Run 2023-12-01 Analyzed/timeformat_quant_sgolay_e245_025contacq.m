...
data = readmatrix('E245 time conversion of formatted raw tab - time tab only');
...
%%%% this melt has 228 points in E245!!!
...
data = data(:,1:320);
x = data(:,1:2:end); % organize temp(C) data
y = data(:,2:2:end); % organize raw fluorescence data
